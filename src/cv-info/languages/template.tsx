...
export const PERSONAL_INFORMATION: PersonalInformation = {
	...
	summary: (
		<>
			Airedale who moved my cheese when the cheese comes out everybody&apos;s
			happy. Cheeseburger cheese and wine danish fontina feta smelly cheese
			smelly cheese taleggio halloumi. Everyone loves stilton feta ricotta the
			big cheese cheese slices gouda dolcelatte. Gouda jarlsberg.
		</>
	),
	tags: [
		{
...
export const HOBBIES: Hobbies = (
	<div>
		<p className="mb-2">
			...
			{", "}
			<Link href="https://cjoecker.github.io/3-point-estimator/">
				3 Point Estimator
			</Link>
			{", "}
			<Link href="https://cjoecker.github.io/core-values-finder/">
				Core Values Finder
			</Link>
			{", "}
			...
			descriptionBlocks: [
				{
					text: (
						<>
							<p>
								Swab cable nipper Sea Legs skysail fathom barque reef sails poop
								deck no prey, no pay. Cackle fruit holystone dance the hempen
								jig Buccaneer handsomely Shiver me timbers gally lass chase guns
								Privateer.
							</p>
							<p>
								Barque take a caulk swab parley gun starboard long boat bounty
								loaded{" "}
								<Link href="https://www.google.com/">
									holystone dance the hempen jig Buccaneer
								</Link>{" "}
								to the gunwalls broadside.
							</p>
							<p>
								Log yawl hearties salmagundi tack gangplank lass schooner crack
								Jennys tea cup yardarm. Fluke tender long boat draft gaff
								broadside gunwalls scurvy snow.
							</p>
						</>
					),
				...
				},
				{
					text: (
						<p>
							Scallywag ye Sea Legs warp gaff squiffy ahoy jolly boat rutters
							walk{" "}
							<Link href="https://youtu.be/">the plank Nelsons folly </Link>{" "}
							hulk strike colors Arr prow chantey scuppers six pounders snow.
						</p>
					),
			...
			descriptionBlocks: [
				{
					text: (
						<p>
							Barkadeer to go on account league blow the man down aye Pirate
							Round nipperkin cutlass Davy Jones&apos; Locker marooned. Parrel
							cackle fruit dance the hempen jig poop deck man-of-war mutiny
							hogshead tack walk the plank gibbet. Matey lugger holystone
							boatswain bilged on her anchor warp interloper heave down pirate
							grog blossom.
						</p>
					),
					tagsTitle: "Main Tasks",
			...
			descriptionBlocks: [
				{
					text: (
						<>
							<p>
								Mizzen league lad heave down crimp lugger bucko squiffy
								landlubber or just lubber tackle. Matey{" "}
								<Link href="https://youtu.be/">salmagundi tackle lass</Link> fer
								yer chains scourge of the seven seas Sink me lass salmagundi
								loaded to the gunwalls. Snow pink bilge rat knave hulk
								handsomely boatswain salmagundi tackle lass.
							</p>
						</>
					),
					tagsTitle: "Tech Stack",
			...
			descriptionBlocks: [
				{
					text: (
						<p>
							Development of{" "}
							<Link href="https://www.facebook.com">killick Davy Jones</Link>{" "}
							Mizzen league lad heave down crimp lugger bucko squiffy.
						</p>
					),
					tagsTitle: "Tech Stack",
			...
			descriptionBlocks: [
				{
					text: (
						<p>
							Gangway mutiny fore killick Davy Jones&apos; Locker lateen sail
							nipper dead men tell no tales schooner gaff. Tackle scurvy d
						</p>
					),
					tagsTitle: "Focus",
					tags: [
			...
			descriptionBlocks: [
				{
					text: (
						<p>
							Awards: Best Liar Ever – German state merit scholarship 2012 –
							2013
						</p>
					),
					tagsTitle: "Focus",
