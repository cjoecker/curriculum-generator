...
export const PERSONAL_INFORMATION: PersonalInformation = {
	...
	summary: (
		<>
			Working for more than {EXPERIENCE_YEARS} years in the tech industry, my
			passion is to improve people&#39;s lives with software. Technology and
			working methods are for me just a mean to make that happen. Having fun in
			team and constructive discussions at eye level to make ideas better is
			also high priority for me.
		</>
	),
	tags: [
		{
...
export const HOBBIES: Hobbies = (
	<p>
		...
		<p>
			<strong>Open source contributions:</strong> Material-UI, Framer-motion,
			Remix, and Prisma
		</p>
	</p>
);
					...
					text: (
						<>
							...
							<p>
								...
								.I have done the user research, service design, requirements
								engineering, full-stack development, DevSecOps and QA.
							</p>
						</>
					),
			...
			descriptionBlocks: [
				{
					text: (
						<>
							<p>
								Development of custom web applications for companies in
								different industries like automobile, tourism, airlines,
								robotics, and medicine.
							</p>
							<p>
								In my latest project, I was leading a team of 6 developers and
								designers. We were developing a{" "}
							...
							<p>
								Before that, I was working for one of the biggest automobile
								manufacturers in Germany. We were developing 13 internal
								applications for logistics, in a team of 40 developers in 5
								countries.
							</p>
						</>
					),
				...
				},
				{
					text: (
						<p>
							UX/UI design and{" "}
							<Link href="https://youtu.be/q1MWfU4jGc8">
								agile requirements engineering
							</Link>{" "}
							for web and mobile applications before or during the development
							of the applications.
						</p>
					),
			...
			descriptionBlocks: [
				{
					text: (
						<p>
							Tech lead and area management of 10 employees. Foundation and
							training of subsidiary department in Shanghai, China. Set
							guidelines and patterns for the virtual commissioning in the
							automobile industry.
						</p>
					),
					tagsTitle: "Main Tasks",
			...
			descriptionBlocks: [
				{
					text: (
						<>
							<p>
								Development of{" "}
								<Link href="https://youtu.be/kQpgYI0kBF8">
									3D behavior models
								</Link>{" "}
								for the virtual commissioning of high complex automated
								production lines. Design and development of UI&apos;s for the
								analysis and processing of signals from devices like PLCs and
								industrial robots.
							</p>
						</>
					),
			...
			descriptionBlocks: [
				{
					text: (
						<p>
							Dual study with exchange in Kelly School of Business (USA),
							Jönköping International Business School (Sweden) and Tokyo
			...
			descriptionBlocks: [
				{
					text: (
						<p>
							Awards: Deutschlandstipendium – German state merit scholarship
							2012 – 2013
						</p>
					),
					tagsTitle: "Focus",
